...
class SingleByteXORScore
{
    ...
    protected static function scoreASCII(string $data, array $overrideWeights = []): float
    {
    ...
    static function score(string $input, array $overrideWeights = []): array
    {
        ...
        for ($i = 0; $i < 256; $i++) {
            ...
            $scores[$i] = static::scoreASCII($trial, $overrideWeights);
        }
